...
def touin8(r):
    return np.clip(r * 255, 0, 255.).to(np.unit8)

def to_pygame_color(rgb):
    # color = pygame.Color(touin8(rgb[0]), touin8(rgb[1]), touin8(rgb[2]))
    color = (touin8(rgb[0]), touin8(rgb[1]), touin8(rgb[2]))
    return color 
